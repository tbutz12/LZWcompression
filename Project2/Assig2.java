 ...
 * program as given, with no changes.  Your program output should be identical to
 * that provided, with the possible exception of the raw hash table (but even this
 * could easily match the expected output exactly).  See a LOT of comments
 * below describing what you need in your PHPArray class so that it will work as
 * specified.
 * Adapted from Dr. John Ramirez's CS 1501 Assignment 2
 */
public class Assig2
{
	public static void main(String [] args)
	{
		...
		// you may have to look up some Java ideas and constructs to see how they
		// are done.  The parameter in the constructor is the initial size of the hash
		// table.
		...
		// 		value of type V
		// (i.e. an arbitrary parameterized type).  The idea of this class is
		...
		// must exactly match mine. This method should show the indices and contents of
		...
		System.out.println("\n\tDemonstrating change_key_case extra credit implementation");
		C.reset();
		//extra credit
		C.array_change_key_case();
		while ((currC = C.each()) != null)
		{
			System.out.println("Key: " + currC.key + " Value: " + currC.value);
		}
	...
	// Iterators are also discussed in your CS 0445 text
