						...
						synchronized (this)
						{
							...
							BufferedReader tempReader =
													new BufferedReader(
																...
																String check = tempReader.readLine();
																if(check.equals("SYS")){
																...
																PrintWriter	myWriter =
													             new PrintWriter(
													                 new BufferedWriter(
													                     new OutputStreamWriter(newSocket.getOutputStream())), true);
																				myWriter.write(ack);
																				myWriter.write("\n");
																				myWriter.flush();
																}
																String check2 = tempReader.readLine();
																if(check2.equals("SYSACK")){
																	System.out.println("SYSACK");
